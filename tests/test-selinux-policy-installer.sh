...
grep -q 'class netlink_generic_socket { bind create getattr setopt write };' "$BASE_TE"
...
grep -q 'class rawip_socket { bind create getattr node_bind read setopt };' "$BASE_TE"
grep -q 'allow init_t self:netlink_generic_socket { bind create getattr setopt write };' "$BASE_TE"
grep -q 'allow init_t self:rawip_socket { bind create getattr read setopt };' "$BASE_TE"
