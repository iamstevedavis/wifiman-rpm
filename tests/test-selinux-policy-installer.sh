...
grep -q 'class netlink_generic_socket { bind create getattr setopt };' "$BASE_TE"
...
grep -q 'class rawip_socket { bind getattr node_bind setopt };' "$BASE_TE"
grep -q 'allow init_t self:netlink_generic_socket { bind create getattr setopt };' "$BASE_TE"
grep -q 'allow init_t self:rawip_socket { bind getattr setopt };' "$BASE_TE"
